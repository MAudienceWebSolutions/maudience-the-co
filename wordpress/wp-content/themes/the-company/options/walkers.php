...
if ( ! class_exists( 'Crb_WC_Product_Cat_List_Walker' ) ) :

class Crb_WC_Product_Cat_List_Walker extends Walker {
	...
	public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
		// Custom Code - Begin
		static $top_level_menu_index = 0;
		if ( $depth == 1 && $top_level_menu_index == 0 ) {
			$output .= '<li class="all">All</li>';
			$top_level_menu_index++;
		} elseif ( $depth != 1 ) {
			$top_level_menu_index = 0;
		}
		// Custom Code - End
